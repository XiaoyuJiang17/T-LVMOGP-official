...
| ----- | -----|
| SGPRN [(code)](https://github.com/shib0li/Scalable-GPRN/tree/main)  | Scalable Variational Gaussian Process Regression Networks (IJCAI 2020) [(paper)](https://arxiv.org/abs/2003.11489) |
