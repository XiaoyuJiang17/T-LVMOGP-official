...
This repository contains the official PyTorch implementation for the ICML 2026 paper "[*Transformed Latent Variable Multi-Output Gaussian Processes*](https://arxiv.org/abs/2605.05133)". In this work, we propose a flexible multi-output deep
